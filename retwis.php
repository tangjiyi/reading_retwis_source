...
# Get the "auth" cookie from the user. If there is no cookie, the user is not logged in
# Check if <authcookie> field in the auths Hash exists, and also verify that user:1000 auth field also matches
